...
<div className="relative mb-8 flex flex-col items-center">
  ...
  {/* Layered Ambient Glows - Multiple layers create a richer light effect */}
  <div className="pointer-events-none absolute -top-12 h-32 w-96 rounded-full bg-amber-500/15 blur-[100px]" />
  ...
  <div className="relative flex flex-col items-center text-center">
    ...
    {/* Title: Letter-spacing & Gradient for Premium Look */}
    <div className="space-y-2">
      <h2 className="text-2xl font-black tracking-tighter text-white sm:text-4xl">
        Decisions<span className="text-amber-400/80">.</span>
      </h2>
      
      {/* Sub-Header / Tagline */}
      <p className="text-[10px] uppercase tracking-[0.3em] text-amber-400/60 font-medium">
        Configure your pricing architecture
      </p>
    </div>

    {/* Modern Divider: Ultra-thin with a "shimmer" feel */}
